...
class Block:
    def __init__(self, index, data, previous_hash, difficulty, miner, miner_rewards):
        self.index = index
        self.data = data
#       self.nonce = nonce 
...
class BlockChain:
    ...
    def create_genesis_block(self):
        ...
        new_block = Block(0, 'This is a genesis block', '0' , 4 , 'user0', self.miner_rewards)
        new_block.hash = self.get_hash(new_block, 0)
        self.chain.append(new_block)
        print(f"Index: {new_block.index}, Data: {new_block.data}, Hash found: {new_block.hash} @ difficulty {self.difficulty}")
    ...
    def mine_block(self, miner, data):
        ...
        new_block = Block(last_block.index + 1, data, last_block.hash, self.difficulty, miner, self.miner_rewards)
        ...
        print(f"Index: {new_block.index}, Data: {new_block.data}, Previous Hash found: {last_block.hash}, Hash found: {new_block.hash} @ difficulty {self.difficulty}, time cost: {time_consumed}s")
        self.chain.append(new_block)
